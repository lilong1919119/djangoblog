"""
Django settings for lilong project.
...
ALLOWED_HOSTS=['127.0.0.1','localhost','.blackeye.top']   #生产环境下的ip配置
...
WSGI_APPLICATION = 'lilong.wsgi.application'
